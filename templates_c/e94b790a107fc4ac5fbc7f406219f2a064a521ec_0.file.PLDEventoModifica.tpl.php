<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-07 16:13:41
  from 'C:\xampp\htdocs\playadice\templates\PLDEventoModifica.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f048315413177_38128189',
...
function content_5f048315413177_38128189 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
" class="form-control" id="example-date-input" value="<?php echo $_smarty_tpl->tpl_vars['fasce']->value[$_smarty_tpl->tpl_vars['numfascia']->value]->getDataStr();?>
">
                                    </div>
                                    <label  class="col-2 col-form-label"><b>Giorno di Fine</b></label>
                                    <div class="col-10">
                                        <input type="text" name="<?php echo $_smarty_tpl->tpl_vars['foo']->value+11;?>
" class="form-control" id="example-date-input" value="<?php echo $_smarty_tpl->tpl_vars['fasce']->value[$_smarty_tpl->tpl_vars['numfascia']->value]->getDataFine();?>
" >
                                    </div>
                                </div>
                            </div>
