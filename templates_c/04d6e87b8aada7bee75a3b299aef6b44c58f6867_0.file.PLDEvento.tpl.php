<?php
/* Smarty version 3.1.34-dev-7, created on 2020-07-14 23:21:53
  from 'C:\xampp\htdocs\playadice\templates\PLDEvento.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f0e21f1cd4517_50745358',
...
function content_5f0e21f1cd4517_50745358 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
>
    <?php echo '<script'; ?>
 src="../Resources/bootstrap.js"><?php echo '</script'; ?>
>
...
if (is_null($_smarty_tpl->tpl_vars['error']->value)) {?>
    <?php } else {
if ($_smarty_tpl->tpl_vars['error']->value == true) {?><hr>
    <div class="alert alert-warning text-center">
        <br>Ti sei già prenotato! <br></div>
<?php } else { ?><div class="alert alert-warning text-center">
    <br>Hai già disdetto la prenotazione<br></div><?php }
}
...
" method="post">
        ...
        <div class="row">
            <div class="col-lg-6 order-2 order-lg-1 p-0">
                <img class="img-fluid d-block" src="../Resources/assets/EventImages/<?php echo $_smarty_tpl->tpl_vars['results']->value[0]->getId();?>
...
">Modifica</a></div>
                            ...
                            <?php if (boolval($_smarty_tpl->tpl_vars['results']->value[0]->getFlag())) {?>
                                    <?php if (!$_smarty_tpl->tpl_vars['check']->value || $_smarty_tpl->tpl_vars['book']->value) {?>
                                        <div class="col">
...
?<?php echo $_smarty_tpl->tpl_vars['results']->value[0]->getId();?>
" method="post">
                                                                    <button type="submit"  class="btn btn-primary">Si
                                                                    </button>
                                                                </form>
                        ...
                        <?php } else { ?> <div class="col"> <form action="/playadice/evento/delete?<?php echo $_smarty_tpl->tpl_vars['results']->value[0]->getId();?>
" method="post"> <button class="btn btn-primary" type="submit" >Annulla</button></form></div>
                        <?php }?>
